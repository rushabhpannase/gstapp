    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginLeft: '70px' , marginTop: '-15px'}}>
                ...
                <div><Checkbox Checked /><label style={{ fontSize: '14px', marginRight: '10px' }}>Indicates Adance Reconciliation Suggestions</label></div>
            </div>
            <div style={{ display: 'flex', marginLeft: '75px', marginRight: '10px', marginTop:'15px' }}>
                <div>
                    <div style={{ marginLeft: '10px', marginTop: 'px' }}>
                        <TableContainer component={Paper} style={{ backgroundColor: '#e3f2fd' }}>
                            <Table sx={{ minWidth: '20px' }} aria-label="simple table">
                                <TableHead>
                                    <TableRow>
                                        <TableCell><h4 style={{ fontSize: '14px', fontWeight: 'bold', color: '#6E738E', marginBottom:'-8px' }}>SUMMARY</h4></TableCell>
                                    </TableRow>
                                    <TableRow>
                    ...
                    <div style={{}}>
                        <FormControl sx={{ minWidth: 220 }} size="small">
                            ...
                            <Select
                                ...
                                label="Match Status"
                                onChange={handleChange}
                                startAdornment={<SearchOutlinedIcon fontSize="small" style={{color:'gray', margin:'2px'}} />}
                            >
                                <MenuItem value="">
                                    <em>None</em>
                                </MenuItem>
