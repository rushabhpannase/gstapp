...
const handleCheckboxClick = (event, rowId) => {
    if (rowId === 'header') {
      if (event.target.checked) {
        const newSelectedRows = rows.map(row => row.INV_NUM);
      ...
      >
        ...
        <div>
          ...
          <label style={{ fontSize: "14px", marginRight: "10px" }}>
            Indicates Adance Reconciliation Suggestions
          </label>
        </div>
      </div>
      <div style={{ display: "flex", marginLeft: "75px", marginRight: "10px" }}>
            ...
            >
              <Table sx={{ minWidth: "20px" }} aria-label="simple table">
                <TableHead>
                  ...
                  <TableRow>
                    <TableCell>
                      <h5 style={{ fontSize: "12px" }}>Data Type</h5>
                      <h6 style={{ fontSize: "12px" }}>Supplier</h6>
                      <h6 style={{ fontSize: "12px" }}>Purchase(My Data)</h6>
                    </TableCell>
                    <TableCell>
                      <h5 style={{ fontSize: "12px" }}>No. of Docs</h5>
                      <h6 style={{ fontSize: "12px" }}>349</h6>
                      <h6 style={{ fontSize: "12px" }}>342</h6>
                    </TableCell>
                    <TableCell>
                      <h5 style={{ fontSize: "12px" }}>Taxable Value</h5>
                      <h6 style={{ fontSize: "12px" }}>41,25,830,95</h6>
                      <h6 style={{ fontSize: "12px" }}>43,23,842,61</h6>
                    </TableCell>
                    <TableCell>
                      <h5 style={{ fontSize: "12px" }}>Tax Value</h5>
                      <h6 style={{ fontSize: "12px" }}>2,58,886,52</h6>
                      <h6 style={{ fontSize: "12px" }}>2,66,.52.70</h6>
                    </TableCell>
                    <TableCell>
                      <h5 style={{ fontSize: "12px" }}>Tax Difference</h5>
                      <h6 style={{ fontSize: "12px" }}>(7,166,18)</h6>
                      <h6> </h6>
                    </TableCell>
                  </TableRow>
                </TableHead>
        ...
        <div style={{ marginLeft: "20px", marginTop: "0px", display: "flex" }}>
          <div style={{}}>
            <FormControl sx={{ minWidth: 230 }} size="small">
              ...
              <Select
                ...
                label="Match Status"
                onChange={handleChange}
                startAdornment={<SearchOutlinedIcon style={{margin:'2px', color:'gray'}} fontSize="small" />} 
              >
                <MenuItem value="">
                  <em>None</em>
                </MenuItem>
          ...
          <div style={{ marginLeft: "15px" }}>
            <Button variant="outlined" style={{ backgroundColor: "#E7F1FF" }}>
              Search
            </Button>
          </div>
        </div>
